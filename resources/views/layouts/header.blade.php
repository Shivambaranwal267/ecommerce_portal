    ...
    <nav class="navbar navbar-expand-lg theme-navbar">
      ...
      <span class="navbar-toggler-icon"></span>
            ...
            <div>
                ...
                <a href="{{ url('vendor/signup') }}" target="_blank" class="text-decoration-none text-light">Become a
                    Seller</a>
                ...
                <a href="{{ url('login') }}"
                    class="btn theme-orange-btn btn-sm text-light ms-1 rounded-pill px-3 py-2"><i
