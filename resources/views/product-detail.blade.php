                    ...
                    <section>
                        <div class="container">
                            ...
                            <div class="d-flex">
                                ...
                                <div><a href="#"
                                        class="btn btn-sm theme-orange-btn text-light rounded-pill px-3 py-2">View All</a>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <form>
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div>
                                            <a class="btn theme-orange-btn text-light rounded-pill px-3 py-2">Post a
                                                Comment <i class="fa-solid fa-arrow-right"></i></a>
                                        </div>
