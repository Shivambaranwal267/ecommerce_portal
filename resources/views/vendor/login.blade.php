                    ...
                    <div class="col-lg-6 mt-5 p-5">
                        ...
                        <form method="POST" action="{{ url('vendor/login') }}">
                            ...
                            <div class="text-center p-2">
                                Don't have an account? <a href="{{ url('vendor/signup') }}" class="text-decoration-none">Signup</a>
                            </div>

                            <div class="text-center p-1">
                                <a href="{{ url('vendor/forget') }}" class="text-decoration-none">Forgotten password?</a>
                            </div>
                        </form>
                    </div>
                </div>
